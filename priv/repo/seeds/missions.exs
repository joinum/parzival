defmodule Parzival.Repo.Seeds.Missions do
  ...
  defp tasks do
    [
      ...
      %{
        title: "Chorar",
        description: "Porque perdeste as últimas 4h a fazer debugging quando te esqueceste de descomentar um if"
        mission: Enum.at(missions, 0)
      ...
      %{
        title: "Deus te ajude",
        description: "Se calhar este vídeo pode ajudar na oração: https://www.youtube.com/watch?v=iik25wqIuFo"
